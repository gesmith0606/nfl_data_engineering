...
python scripts/draft_history_replay.py 2 [--sharp]                                       # Point-in-time replay 2021-25 scored by ACTUAL results: 5.64/12 vs ADP field (above market 4 of 5 seasons); 6.30/12 vs sharp-bot field (par — wins 2021-23, loses 2024-25 on stale/news-blind projections). §36/§37 + NEWS guard came from these failures. Unfiltered ghosts ranked 9.94 -> market filter is load-bearing
