...
**In progress**: August dress rehearsal — manually dispatch all 6 workflows once during preseason and verify end-to-end (weekly-pipeline --ml hybrid publish + grading + sanity, odds-capture spreads+props, sunday-refresh, daily-sentiment incl. odds watchdog, deploy-web, weekly-external-projections) | In-season gates (Sept+): line-capture verdict by w10 (mean >+0.3, n≥150), prop-implied eval once Sunday snapshots accumulate
