...
python scripts/draft_history_replay.py 2                                                 # Point-in-time replay 2021-25 scored by ACTUAL results: with rookie inputs + alias fix, mean rank 5.64/12 — above market 4 of 5 seasons; 2025 collapse (injury-blind market-faded stars) produced doctrine §36/§37. Unfiltered ghosts ranked 9.94 -> market filter is load-bearing
