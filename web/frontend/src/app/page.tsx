 ...
 * regenerated 2026-08-16 from the current shipped config — QB/RB now hybrid
 * ML, WR blend fix: overall MAE gap −0.32 vs Sleeper n=7,009 / −0.26 vs ESPN
 * n=6,721; every position (QB/RB/WR/TE) now beats BOTH sources, a full
 * sweep for the first time — see web/frontend/src/features/nfl/config/
 * model-metrics.json, generated by scripts/generate_frontend_metrics.py).
...
const RECEIPTS = [
  { num: '−0.32', label: 'OVERALL vs Sleeper · 7,009 wks', win: true },
  { num: '−0.26', label: 'OVERALL vs ESPN · 6,721 wks', win: true },
  { num: '−0.45', label: 'TE · beats both', win: true },
  { num: '−0.86', label: 'QB · beats both', win: true },
  { num: '−0.31', label: 'RB · beats both', win: true }
] as const;
