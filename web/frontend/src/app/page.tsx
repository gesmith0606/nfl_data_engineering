 ...
 * (.planning/CONSOLIDATION_2026_08_16.md + .planning/SITE_METRICS_REFRESH_2026_08_16.md +
 * .planning/SLEEPER_CONSENSUS_ANCHOR_GATE.md, regenerated 2026-08-22 on the
 * promoted config now shipping the Sleeper consensus anchor default-on for
 * WR (blend, weight=0.5) — overall MAE gap −0.54 vs Sleeper n=7,009 / −0.47
 * vs ESPN n=6,721; every position (QB/RB/WR/TE) still beats BOTH sources, a
 * full sweep, and WR's own gap widened (−0.065→−0.132 vs Sleeper); see
 * web/frontend/src/features/nfl/config/model-metrics.json, generated by
 * scripts/generate_frontend_metrics.py).
 * Yahoo publishes no historical projections, so no Yahoo claim — live 2026
 * capture is running. Static-first: no backend calls on this page.
 */
...
const RECEIPTS = [
  { num: '−0.54', label: 'OVERALL vs Sleeper · 7,009 wks', win: true },
  { num: '−0.47', label: 'OVERALL vs ESPN · 6,721 wks', win: true },
  { num: '−0.45', label: 'TE · beats both', win: true },
  { num: '−1.66', label: 'QB · beats both', win: true },
  { num: '−0.47', label: 'RB · beats both', win: true }
] as const;
