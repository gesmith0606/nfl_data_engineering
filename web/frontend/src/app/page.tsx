 ...
 * regenerated 2026-08-16/17 from the promoted config — QB/RB re-promoted to
 * consolidated span/recency + zone-feature residual models: overall MAE gap
 * −0.51 vs Sleeper n=7,009 / −0.44 vs ESPN n=6,721; every position
 * (QB/RB/WR/TE) still beats BOTH sources, a full sweep — see
...
const RECEIPTS = [
  { num: '−0.51', label: 'OVERALL vs Sleeper · 7,009 wks', win: true },
  { num: '−0.44', label: 'OVERALL vs ESPN · 6,721 wks', win: true },
