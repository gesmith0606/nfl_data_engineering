...
import { ConsentPrompt } from "@/features/marketing/components/consent-prompt";
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  // Without keys the tree is byte-identical to the pre-auth site (Analytics
  // is unconditional — it's a passive Vercel Web Analytics beacon with no
  // Clerk/Stripe dependency and no keys of its own; see docs/BILLING_LAUNCH.md).
