...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/georgesmith/repos/nfl_data_engineering/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/Users/georgesmith/repos/nfl_data_engineering/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/Users/georgesmith/repos/nfl_data_engineering/.claude/commands/gsd
AGENTS_DIR=/Users/georgesmith/repos/nfl_data_engineering/.claude/agents
```
...
<execution_context>
Surface state file: `/Users/georgesmith/repos/nfl_data_engineering/.claude/skills/.gsd-surface.json`
Install profile marker: `/Users/georgesmith/repos/nfl_data_engineering/.claude/skills/.gsd-profile`
Engine module: `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
