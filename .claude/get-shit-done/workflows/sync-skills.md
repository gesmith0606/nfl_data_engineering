...
INSTALL_JS_GLOBAL="/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
