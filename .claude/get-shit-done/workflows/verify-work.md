...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/workflows/transition.md`.
