...
<!-- For checkpoint task examples and patterns, see @/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
