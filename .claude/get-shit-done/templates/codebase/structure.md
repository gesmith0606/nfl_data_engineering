...
- Usage: Reference from command with `@/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/georgesmith/repos/nfl_data_engineering/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/georgesmith/repos/nfl_data_engineering/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
