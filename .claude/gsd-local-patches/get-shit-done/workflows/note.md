...
- **Global scope**: `/Users/georgesmith/repos/nfl_data_engineering/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/georgesmith/repos/nfl_data_engineering/.claude/notes/`)
...
2. Glob `/Users/georgesmith/repos/nfl_data_engineering/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/georgesmith/repos/nfl_data_engineering/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/georgesmith/repos/nfl_data_engineering/.claude/notes/` — works in any directory
