...
@/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/references/ios-scaffold.md
...
@/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/references/executor-examples.md
</deviation_rules>
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `@/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/references/execute-mvp-tdd.md`. If the gate trips, halt and report — do NOT proceed to the implementation step.
