...
Use template from `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
