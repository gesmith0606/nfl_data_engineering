...
<required_reading>
Read `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
