...
<required_reading>
Read `/Users/georgesmith/repos/nfl_data_engineering/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
